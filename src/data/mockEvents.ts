export interface AgendaSlotData {
    id?: string;
    time: string;
    title: string;
    description?: string; // Made optional as per original EventData agenda slot
    speaker?: string;
    aboutSpeaker?: string;
    type?: "talk" | "break" | "workshop" | "panel" | string;
}

export interface AgendaDayData {
    id?: string;
    date: string; // Changed from 'day' to 'date' to match new AgendaDayData structure
    slots: AgendaSlotData[];
}
...
export type EventData = {
    ...
    agenda?: AgendaDayData[]; // Changed type and made optional
    travel?: {
        flight?: string;
